            ...
            notifications.append(
                {
                    ...
                    "tap_action": notif.get("tap_action", "more-info"),
                    "tap_action_entity": notif.get(ATTR_TAP_ACTION_ENTITY),
                    "tap_action_action": notif.get(ATTR_TAP_ACTION_ACTION, []),
                    "tap_action_navigation_path": notif.get("tap_action_navigation_path", ""),
                    "tap_action_url_path": notif.get("tap_action_url_path", ""),
                    "tap_action_service_domain": notif.get(ATTR_TAP_ACTION_SERVICE_DOMAIN, ""),
                    "tap_action_service": notif.get(ATTR_TAP_ACTION_SERVICE, ""),
                    "tap_action_service_data": notif.get(ATTR_TAP_ACTION_SERVICE_DATA, {}),
